...
class CodeGen:
    ...
    def _generate_batch(self, prompt_batch, max_new_tokens=10):
        prompts = self.tokenizer(
            prompt_batch, 
            return_tensors='pt', 
            padding=True, 
            truncation=True,
            max_length=1948  # Reduced max_length to avoid dimension issues
        )
...
if __name__ == '__main__':
    file_path = '/root/evaluation_autocompletion/CodeT/RepoCoder/prompts/new_method-rg-one-gram-ws-20-ss-2-20250324_074243.jsonl'
